...
public class JiraToWord {
    ...
    public static void main(String[] args) throws IOException, ParseException {
        ...
        if(!errorsOccurred){
            /*HashMap<String,String> map = new JiraToWord().jsonToTxt(jsonData);
            new JiraToWord().createDoc(map);*/
            new JiraToWord().getTestCases();
        }
    ...
    public String getTestCases(){
        ...
        System.out.println("\njsonTestCases:");
        System.out.println(jsonTestCases);

        return jsonTestCases;
    }

    public static String getJsonData(String baseURL, String biExportURL, String jSessionID) throws ParseException {
        String jsonData = "";
        try {
    ...
    public void createDoc(HashMap<String,String> map) throws IOException {
        ...
        try (XWPFDocument doc = new XWPFDocument()) {
            ...
            Double estTime = Double.valueOf(map.get("estimatedTime"))*0.00000027777777777778;
            ...
            for (int i = 0; i < testExpectedResults.length; i++) {
                ...
                row.getCell(1).setText(testDescriptions[i].replaceAll("<.*?>", ""));
                ...
                row.getCell(2).setText(testExpectedResults[i].replaceAll("<.*?>", ""));
